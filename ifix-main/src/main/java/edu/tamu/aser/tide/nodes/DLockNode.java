...
public class DLockNode extends SyncNode{
	...
	public DLockNode(int curTID, String instSig, int sourceLineNum, PointerKey key,
			OrdinalSet<InstanceKey> instances, CGNode node, SSAInstruction createinst,IFile file, String filePath ) {
		this.TID = curTID;
...
//		this.prefix = prefix;
	...
	public DLockNode copy(int line){
		...
		return new DLockNode(TID, new_instSig, line, key, instances, node, inst, file, filePath);
	}
