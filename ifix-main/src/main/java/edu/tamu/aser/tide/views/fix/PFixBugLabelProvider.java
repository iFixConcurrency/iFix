...
//
//public class PFixBugLabelProvider extends LabelProvider implements IColorProvider {
...
//		boolean isNewest = ((PFixTreeNode) element).isNewest();
//		if (isNewest) {
//			((PFixTreeNode) element).isNewest = false;
//			return RED;
//		} else {
//			return null;
//		}
