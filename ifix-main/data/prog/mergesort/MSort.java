...
public class MSort extends Thread {
    ...
    public static int AvailableThreadsState()//0 - No threads,1 - 1 thread available,2 - 2 threads avilable
    {
		synchronized (MSort.class) {
